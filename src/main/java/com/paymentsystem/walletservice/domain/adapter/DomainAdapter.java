package com.paymentsystem.walletservice.domain.adapter;

import com.paymentsystem.walletservice.domain.entity.Wallet;
import com.paymentsystem.walletservice.domain.value.VWallet;
import com.paymentsystem.walletservice.domain.value.VWalletData;
